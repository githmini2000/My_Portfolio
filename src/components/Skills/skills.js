...
const Skills = () => {
  return (
    ...
    <span className ='skillDesc'>I build responsive and user-friendly web applications, ensuring seamless functionality and an optimized user experience through modern web technologies.</span>
    <div className='skillBars'>
        ...
        <div className='skillBar'>
            <img src={DB} alt='DB' className='skillBarImg'/>
            <div className='skillBarText'>
